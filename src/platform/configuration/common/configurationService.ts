...
export namespace ConfigKey {
	...
	*/
	export namespace Internal {
		...
		export const InlineEditsXtabCurrentFileMaxTokens = defineExpSetting<number>('chat.advanced.inlineEdits.xtabProvider.currentFileMaxTokens', xtabPromptOptions.DEFAULT_OPTIONS.currentFileMaxTokens, INTERNAL_RESTRICTED);
